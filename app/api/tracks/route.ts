export async function GET() {
  return Response.json([
    ...
    },
    {
      id: 5,
      title: "Разобранная",
      artist: "yuni., SELФHATE",
      imgPreview:
        "https://avatars.yandex.net/get-music-content/5502420/a8a39695.a.22656757-1/200x200",
      src: "/audio/YuNi_-_Bydlocykl_-_Razobrannaya_cover_70384723.mp3",
      listners: "0",
      likes: "0",
    },
    {
